# Description:
#   Display a motivational quote from Gunnery Sergeant Hartman
#
# Dependencies:
#   None
#
...
#
# Commands:
#   hubot motivate (me|<user>)- Receive a motivational quote
#
# Author:
#   carlokruger
...
motivations = [
  ...
  "I will motivate you, Private[USER], IF IT SHORT-DICKS EVERY CANNIBAL ON THE CONGO!",
  "Today... is Christmas! There will be a magic show at zero-nine-thirty!",
  "Chaplain Charlie will tell you about how the free world will conquer Communism with the aid of God and a few Marines! God has a hard-on for Marines because we kill everything we see!",
  ...
  "I am Gunnery Sergeant #{robot.name}, your senior drill instructor. From now on you will speak only when spoken to, and the first and last words out of your filthy sewers will be \"Sir\". Do you maggots understand that?",
  ...
  "Private[USER] I'm gonna give you three seconds; exactly three-fucking-seconds to wipe that stupid looking grin off your face or I will gouge out your eyeballs and skull-fuck you! ONE! TWO! THREE!",
  ...
  "That's enough! Get on your feet. Private[USER] you had best square your ass away and start shitting me Tiffany cufflinks or I will definitely fuck you up!",
  ...
  "Outstanding, Private[USER]. I think we finally found something that you do well.",
  "You slimy scumbag! Get on your face and give me 25.",
  "Private[USER], you are definitely born again hard! Hell, I may even allow you to serve as a rifleman in my beloved Corps.",
  ...
  "Private[USER], are you trying to offend me?",
  "Disappear, scumbag!",
  "Holy dog shit! Texas? Only steers and queers come from Texas, Private[USER], and you don't look much like a steer to me, so that kinda narrows it down. Do you suck dicks?",
  ...
  "Why is Private[USER] out of his bunk after lights-out? Why is Private[USER] holding that weapon? Why aren't you stomping Private[USER]'s guts out?",
  "Holy Jesus! What is that? What the fuck is that? WHAT IS THAT, PRIVATE?",
  "Is chow allowed in the barracks, Private[USER]?",
  "Private[USER] has dishonored himself and dishonored the platoon. I have tried to help him. But I have failed. I have failed because YOU have not helped me. YOU people have not given Private[USER] the proper motivation! So, from now on, whenever Private[USER] fucks up, I will not punish him! I will punish all of YOU! And the way I see it ladies, you owe me for ONE JELLY DOUGHNUT! NOW GET ON YOUR FACES!",
  ...
  "The fairy fucking godmother said it. Out-fucking-standing! I will PT you all until you fucking die! I'll PT you until your assholes are sucking buttermilk!",
  "Was it you, you scroungy little fuck, huh? You little piece of shit! You look like a fucking worm! I bet it was you!",
  "Well, no shit. What have we got here, a fucking comedian? ... I admire your honesty. Hell, I like you, you can come over to my house and fuck my sister!",
  ...
  "Private[USER], your ass looks like about a hundred and fifty pounds of chewed bubblegum!"
]
